...
void main(List<String> arguments) async {
  ...
  final coinbaseMessage = 'Mined by RafaelFernandes';
  final address = '1rafaeLAdmgQhS2i4BR1tRst666qyr9ut';
  final extranonceStart = 0;
  final timeout = 10; // time in seconds to get a new blcktemplate
  ...
  dynamic rpc(String method, [dynamic params]) async {
    ...
    try {
      final response = await http.post(
        // Uri.parse(rpcUrl),
        Uri.parse('https://btc.getblock.io/<your-key>/mainnet/'),
        headers: headers,
        body: data,
        encoding: utf8,
      );
